                  ...
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      <label for="title" class="block text-sm font-medium text-gray-700">Title Book</label>
                        ...
                        @enderror
                      <input required type="text" name="title" id="title" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full h-10 px-2 shadow-md sm:text-sm border-gray-300 rounded-md" value="{{ old('title') }}">
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                      <label for="text" class="block text-sm font-medium text-gray-700">Author</label>
                        @error('author')
                            <span class="mt-2 text-center text-sm text-red-600">{{ $message }}</span>
                        @enderror
                      <input required type="text" name="author" id="author" autocomplete="address-level2" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full h-10 px-2 shadow-md sm:text-sm border-gray-300 rounded-md" value="{{ old('author') }}">
                    </div> 
                    ...
                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                      <label for="publisher" class="block text-sm font-medium text-gray-700">Publisher</label>
                        @error('publisher')
                            <span class="mt-2 text-center text-sm text-red-600">{{ $message }}</span>
                        @enderror
                      <input required type="text" name="publisher" id="publisher" autocomplete="address-level2" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full h-10 px-2 shadow-md sm:text-sm border-gray-300 rounded-md" value="{{ old('publisher') }}">
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                      <label for="image" class="block text-sm font-medium text-gray-700">Image</label>
                        @error('image')
                            <span class="mt-2 text-center text-sm text-red-600">{{ $message }}</span>
                        @enderror
                      <input required type="file" name="image" id="image" autocomplete="address-level2" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full h-10 px-2 shadow-md sm:text-sm border-gray-300 rounded-md" value="{{ old('image') }}">
