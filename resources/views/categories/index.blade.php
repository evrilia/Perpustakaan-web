...
<main class="bg-white shadow">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-gray-900 text-center uppercase">Categories data list</h1>
    </div>
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
          <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
              ...
              <div class="ml-4 px-4 py-3 bg-gray-50 text-center sm:px-6">
                <a href="/categories/create" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 no-underline">Input Categories</a>
              </div>
            </div>
          </div>
            ...
            <table class="table-auto w-full ">
              <thead class="bg-gray-50 border-b-2 border-gray-200">
                <tr>
                  ...
                  <th class="w-32 p-3 text-sm font-semibold tracking-wide text-left">Categories name</th>
                  <th class="w-32 p-3 text-sm font-semibold tracking-wide text-left">published</th>
              ...
              <tbody class="divide-y divide-gray-200">
                @foreach ($categories as $category)    
                  <tr>
                    ...
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
                      <a href="{{ url('/categories/' . $category->id . '/edit') }}" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 no-underline">Edit</a>
                      <form action="/categories/destroy" method="post" class="inline">
                        @method('delete')
                        @csrf
          ...
          <div class="grid grid-cols-1 xl:grid-col-2 gap-4 lg:hidden">
            ...
            <div class="bg-white space-y-3 p-4 rounded-lg shadow">
              ...
              <div>
                <div class="text-gray-500">{{ $category->created_at }}</div>
                <div class="mt-4">
                  <a href="{{ url('/categories/' . $category->id . '/edit') }}" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 no-underline">Edit</a>
                  <form action="/categories/destroy" method="post" class="inline">
                    @method('delete')
